...
\begin{enumerate}[leftmargin=*, labelindent=6.5em, font=\bfseries]
  ...
  % \item[PLDI 2026] {Incremental Live Functional Programming with Holes} (Thia)
  % \item[ICFP 2026] {Collaborative Computational Authoring with Live Projections} (Alexander)
  % \item[OOPSLA 2025] {Computational Authoring with Live Projections} (Alexander)
  % \item[OOPSLA 2025] {Incremental Type Error Localization and Recovery with Holes} (Thia)
  % \item[ESOP 2025] {Explicit Implicits} (Thomas)
  % \item[ICFP 2025] {Selectively Stepping through Functional Programs with Holes} (Matthew)
  % \item[PLDI 2025] {Syntactic Completion with Material Obligations} (David)
  % \item[POPL 2025] {Grove: A Convergent Collaborative Structure Editor Calculus} (Eric, Vishnu)
  % \item[POPL 2025] {Semantically Contextualizing Large Code Models} (Andrew)
  % \item[Onward! 2024] {Capability Safety is Critical for Agentic AI Safety}
...
\begin{itemize}
  \item \textbf{EECS 490: Programming Languages}
        \begin{itemize}
          \item Winter 2020, Fall 2020, Winter 2021, Fall 2021, Winter 2022, Fall 2022, Winter 2023, Fall 2023, Winter 2024
        \end{itemize}
...
\begin{itemize}
  ...
  \item PhD Students (advised)
        \begin{enumerate}
          \item Alexander Bandukwala (incoming Fall 2024)
            \begin{itemize}
              \item \textbf{NSF CSGrad4US Fellowship}
            \end{itemize}
          \item Thomas Porter (incoming Fall 2024)
  ...
  \item PhD Students (committee membership)
        \begin{enumerate}
          ...
          \item Matthias Gissurarson (Chalmers University of Technology, anticipated Summer 2024)
        \end{enumerate}
  \item Masters and Undergraduate Advisees (the following lists students who went on to PhD programs only)
        \begin{enumerate}
          \item Eric Zhao (Fall 2022-Winter 2024; PhD student at Brown University)
          \item Matthew Ruiz (Winter 2023-Winter 2024; PhD student at Purdue University)
          \item Yuxiang (Alaric) Chen (Fall 2022-Winter 2024; PhD student at Purdue University)
          \item Yanjun Chen (Winter 2020-Winter 2024; PhD student at UC Irvine)
...
\begin{itemize}
  \item Enhancing Engineering Education (E3): Modularizing Foundational Engineering Courses with Classroom Proof Assistants (2024-2025)
    \begin{itemize}
      \item Co-PIs: Greg Bodwin, Max New, Jean-Baptiste Jeannin 
      \item Total: \$50,000 
    \end{itemize}
  \item Michigan Engineering Seeding to Accelerate Research Themes (START): Interactively Deriving Formal Proofs (2023-2024)
        \begin{itemize}
