...
\begin{enumerate}
  \item Distinguished Paper Award, OOPSLA 2025
...
% \begin{enumerate}[leftmargin=*, labelindent=6.5em, font=\bfseries]
  ...
  % \item[ICFP 2026]{Hazel Prover: A Classroom Proof Assistant for Discrete Mathematics}
  % \begin{itemize}
  %   \item \advisee{A. Blinn}, \advisee{X. Liang}, \advisee{J. Kim}, \textbf{C. Omar}
  %   \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2024
  % \end{itemize}
  % \item[PLDI 2026]{Type-and-Test-Driven Development with AI Agents}
  % \begin{itemize}
  %   \item \advisee{A. Blinn}, \advisee{X. Liang}, \advisee{J. Kim}, \textbf{C. Omar}
  %   \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2024
  % \end{itemize}
  %  \item[PLDI 2026]{Computational Authoring with Typed Holes}
  % \begin{itemize}
  %   \item \advisee{A. Blinn}, \advisee{X. Liang}, \advisee{J. Kim}, \textbf{C. Omar}
  %   \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2024
  % \end{itemize}
  % \item[OOPSLA 2026]{Live Programming with Probes}
  % \begin{itemize}
  %   \item \advisee{A. Blinn}, \advisee{X. Liang}, \advisee{J. Kim}, \textbf{C. Omar}
  %   \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2024
  % \end{itemize}
  % \item[Aarhus 2025]{Live Programming with Probes}
  % \begin{itemize}
  %   \item \advisee{A. Blinn}, \advisee{X. Liang}, \advisee{J. Kim}, \textbf{C. Omar}
  %   \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2024
  % \end{itemize}
  % \item[VL/HCC 2025]{Structure Editor for Semantic Derivations in the Classroom}
  % \begin{itemize}
  %   \item \advisee{A. Blinn}, \advisee{X. Liang}, \advisee{J. Kim}, \textbf{C. Omar}
  %   \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2024
  % \end{itemize}
...
\begin{enumerate}[leftmargin=*, labelindent=6.5em, font=\bfseries]
  ...
  \begin{itemize}
    \item \advisee{T. J. Porter}, M. Kirisame, \advisee{I. Wei}, P. Panchekha, \textbf{C. Omar}
    \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2025
    \item \textbf{Distinguished Paper Award}
  \end{itemize}
    
  \item[OOPSLA 2025] {Syntactic Completions with Material Obligations}
  \begin{itemize}
    \item \advisee{D. Moon}, \advisee{A. Blinn}, \advisee{T. J. Porter}, \textbf{C. Omar}
    \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2025
  \end{itemize}

  \item[PROPL 2025] {A FAIR Case for a Live Computational Commons}
  \begin{itemize}
    \item \textbf{C. Omar}, M. Coblenz, A. Madhavapeddy
    \item \textit{Programming for the Planet (PROPL) Workshop}, colocated with SPLASH 2025
  \end{itemize}

  \item[VL/HCC 2025] {Hazel Deriver: A Live Editor for Constructing Rule-Based Derivations}
  \begin{itemize}
    \item \advisee{Z. Zhong}, \textbf{C. Omar}
          \item \textit{IEEE Symposium on Visual Languages and Human-Centered Computing}
  \end{itemize}  
  \newpage
  \item[VL/HCC 2025] {DeckFlow: Iterative Specification on a Multimodal Generative Canvas}
  \begin{itemize}
    \item \advisee{G. Croisdale}, {E. Huang}, {J. J. Y. Chung}, A. Guo, X. Wang, A. Z. Henley, \textbf{C. Omar}
          \item \textit{IEEE Symposium on Visual Languages and Human-Centered Computing}
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item \textit{Aarhus Conference}
  \end{itemize}
  \item[POPL 2025]{Grove: A Bidirectionally Typed Collaborative Structure Editor Calculus}
  \begin{itemize}
    \item \advisee{M. Adams}, \advisee{E. Griffis}, \advisee{T. J. Porter}, \advisee{S. Satish}, \advisee{E. Zhao}, \textbf{C. Omar}
  ...
  \begin{itemize}
    \item \advisee{M. Keenan}, \textbf{C. Omar}
  ...
  \begin{itemize}
    \item \advisee{E. Zhao}, \advisee{R. Maroof}, \advisee{A. Dukkipati}, \advisee{A. Blinn}, \advisee{Z. Pan}, \textbf{C. Omar}
  ...
  \item[VL/HCC 2022] {RustViz: Interactively Visualizing Ownership and Borrowing}
        \begin{itemize}
          \item \advisee{M. Almeida}, \advisee{G. Cole}, \advisee{K. Du}, \advisee{G. Luo}, \advisee{S. Pan}, \advisee{Y. Pan}, \advisee{K. Qiu}, \advisee{V. Reddy}, \advisee{H. Zhang}, \advisee{Y. Zhu}, \textbf{C. Omar}
          \item \textit{IEEE Symposium on Visual Languages and Human-Centered Computing}
        \end{itemize}
  \item[VL/HCC 2022] {An Integrative Human-Centered Architecture for Interactive Programming Assistants}
        \begin{itemize}
          \item \advisee{A. Blinn}, \advisee{D. Moon}, \advisee{E. Griffis}, \textbf{C. Omar}
          \item \textit{IEEE Symposium on Visual Languages and Human-Centered Computing} 
        \end{itemize}
  \item[TyDe 2022] {tylr: A Tiny Tile-Based Structure Editor}
        \begin{itemize} 
          \item \advisee{D. Moon}, \advisee{A. Blinn}, and \textbf{C. Omar}
          \item \textit{Workshop on Type-Driven Development}
        \end{itemize}
  \item[PLDI 2021] {Filling Typed Holes with Live GUIs}
        \begin{itemize}
          \item \textbf{C. Omar}, \advisee{D. Moon}, \advisee{A. Blinn}, I. Voysey, N. Collins, and R. Chugh
  ...
  \item[HATRA 2020] Hazel Tutor: Guiding Novices Through Type-Driven Development
        \begin{itemize}
          \item \advisee{H. Potter} and \textbf{C. Omar}
...
%   \begin{itemize}
%     \item \textbf{C. Omar}, S. Joshi and F. Cruz
...
\begin{enumerate}
  \item Invited talk, Ink \& Switch London Meetup, August 2025
...
\begin{itemize}
  ...
  \item \textbf{EECS 490: Programming Languages}
        ...
        \end{itemize}
  \item \textbf{CSE 590: Advanced Programming Languages}
        \begin{itemize}
          \item Winter 2026
        \end{itemize}
...
\begin{itemize}
  \item Postdocs and Research Scientists (advising period; subsequent placement)
        \begin{enumerate}
          \item David Moon (Fall 2026-present)
  ...
  \item PhD Students (advised)
        \begin{enumerate}
          ...
          \item Gregory Croisdale (Summer 2024-Summer 2025)
          \item Matthew Keenan (Fall 2023-present)
          \item Andrew Blinn (Fall 2020-present)
          \item Eric Griffis (Fall 2020-Summer 2022)
            \begin{itemize}
              \item \textbf{Rackham Merit Fellowship}
            \end{itemize}
          \item David Moon (Fall 2019-Summer 2025)
            \begin{itemize}
              \item Dissertation: \textit{Syntactic Completions with Material Obligations}
            \end{itemize}
        \end{enumerate}
  \item PhD Committees
        \begin{enumerate}
...
\begin{itemize}
  ...
  \item Undergraduates (year; faculty advisor; subsequent placement)
        \begin{enumerate}
          % \item Charles Chamberlain (2017-2018; Ravi Chugh; Jane Street Capital)
...
\begin{enumerate}
  \item Chair, ACM SIGPLAN International Workshop on Programming for the Planet, PROPL 2026
...
\begin{enumerate}
  \item Member, CSE Course Review Committee, Fall 2025-Winter 2026
...
% \begin{enumerate}
% % \item \textbf{C. Omar} and C. Le Goues. Statistically Ranked, Type-Aware Action Suggestions. \textit{POPL 2018}. 
% % \item \textbf{C. Omar} and J. Aldrich. Reasonably Programmable Syntax. \textit{ICFP 2017}. 
% % \item \textbf{C. Omar}, I. Voysey, M. Hilton, J. Aldrich and M. Hammer. Hazelnut Live: Semantic Foundations for Evaluating Incomplete Programs. \textit{ICFP 2017}.
% % \item \textbf{C. Omar} and J. Aldrich. Tidy: A Modularly Programmable Bidirectionally Typed Translation Calculus. \textit{ICFP 2017}. 
