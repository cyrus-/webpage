...
\begin{enumerate}[leftmargin=*, labelindent=6.5em, font=\bfseries]
  ...
  % \item[PLDI 2025] {Capability Safety for Agentic AIs}
  % \item[OOPSLA 2025] {Selectively Stepping through Functional Programs with Holes}
  % \item[POPL 2025] {Syntactic Completion with Material Obligations}
  % \item[POPL 2025] {Grove: A Convergent Collaborative Structure Editor Calculus}
  % \item[OOPSLA 2024] {Semantically Contextualizing Large Language Models}
