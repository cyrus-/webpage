...
\begin{enumerate}
  \item {Gradual Structure Editing with Obligations}
  \begin{itemize}
    \item \advisee{D. Moon}, \advisee{A. Blinn}, \underline{C. Omar}
    \item \textit{IEEE Symposium on Visual Languages and Human-Centered Computing} \textbf{(VL/HCC 2023)}
  \end{itemize}
  \item {Live Pattern Matching with Typed Holes}
        \begin{itemize}
          ...
          \item \textit{Proc. ACM Program. Lang.}, OOPSLA \textbf{(OOPSLA 2023)}
        \end{itemize}
