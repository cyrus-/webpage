...
\item Masters Students
  ...
  \end{enumerate}
\item Undergraduates (as of Apr. 15, 2020, updated yearly)
  \begin{enumerate}
...
\begin{enumerate}
  \item Member, CSE Diversity Committee, Fall 2019-present
    \begin{enumerate}
      ...
      \item Led development of the Summer 2020 Graduate Student Individual Check-In program
    \end{enumerate}
