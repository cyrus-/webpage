...
\begin{enumerate}[leftmargin=*, labelindent=6.5em, font=\bfseries]
  ...
  \begin{itemize}
    ...
    \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2024
  \end{itemize}
  % \item[HATRA 2024]{Design Criteria for Classroom Proof Assistants}
  % \begin{itemize}
  %   \item \advisee{A. Blinn}, \advisee{X. Liang}, \advisee{J. Kim}, \underline{C. Omar}
  %   \item \textit{Proc. ACM Program. Lang.}, Issue: OOPSLA 2024
  % \end{itemize}
  ...
  \begin{itemize}
    \item \underline{C. Omar}, A. Madhavapeddy
    \item \textit{Workshop on Higher-Order Programming with Effects (HOPE)}, co-located with ICFP 2024
  \end{itemize}
  ...
  \item[TyDe 2022] {tylr: A Tiny Tile-Based Structure Editor}
        \begin{itemize} 
          \item \advisee{D. Moon}, \advisee{A. Blinn}, and \underline{C. Omar}
...
\begin{itemize}
  ...
  \item PhD Students (committee membership)
        \begin{enumerate}
          ...
          \item Matthías Páll Gissurarson (Chalmers University of Technology, expected 2024)
          \item April Wang (School of Information, 2023)
          \item Xiaoying Pu (CSE, 2022)
        \end{enumerate}
  \item Masters and Undergraduate Advisees (the following lists students who went on to PhD programs only)
        \begin{enumerate}
          \item Matthew Ruiz (Winter 2023-present; PhD student at Purdue University)
          \item Karan Anand (Summer 2023-present)
          \item Junwei Zhou (Winter 2023-Fall 2023)
          \item Alan Yang (Winter 2023-present)
          \item Jonathan Lam (MS student at Cooper Union, Fall 2021-Summer 2022)
          \item Priya Thanneermalai (Summer 2021-Fall 2021)
          \item Soo Yeon (Sean) Lee (Winter 2020-Summer 2021)
          \item Hannah Potter (Fall 2019-Summer 2021; PhD student at University of Washington)
          \item Erin Deutschman (Winter 2020-Summer 2021)
        \end{enumerate}
  \item Undergraduates (the following lists students who went on to PhD programs only)
        \begin{enumerate}
          ...
          \item[...] (100+ other undergraduate and masters research students as of May 1, 2024, see lab website for full listing)
        \end{enumerate}
\end{itemize}
...
\begin{enumerate}
  ...
  \item Programm Committee, SPLASH-E 2024
